...
@InputType()
class InventoryCreateNestedManyWithoutCharactersInput {
...
export { InventoryCreateNestedManyWithoutCharactersInput as InventoryCreateNestedManyWithoutCharactersInput };
