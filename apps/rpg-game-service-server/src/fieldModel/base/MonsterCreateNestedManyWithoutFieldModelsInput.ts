...
@InputType()
class MonsterCreateNestedManyWithoutFieldModelsInput {
...
export { MonsterCreateNestedManyWithoutFieldModelsInput as MonsterCreateNestedManyWithoutFieldModelsInput };
