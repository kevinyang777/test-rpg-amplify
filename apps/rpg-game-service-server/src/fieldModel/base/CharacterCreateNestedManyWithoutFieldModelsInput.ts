...
@InputType()
class CharacterCreateNestedManyWithoutFieldModelsInput {
...
export { CharacterCreateNestedManyWithoutFieldModelsInput as CharacterCreateNestedManyWithoutFieldModelsInput };
